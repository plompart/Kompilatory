...
class Cparser(object):
    ...
    def p_assignment(self, p):
        ...
        id = p[1]
        expression = p[3]
        p[0] = AST.Assignment(id, expression)
    ...
    def p_expression(self, p):
        ...
        if len(p) == 2:
            ...
            id = p[1]
            expression = p[3]
            p[0] = AST.FuncDeclarationsExpr(id, expression)
        else:
            expression1 = p[1]
            operator = p[2]
            expression2 = p[3]
            p[0] = AST.BinExpr(operator, expression1, expression2)
    ...
    def p_fundef(self, p):
        ...
        if len(p) == 7:
            ...
            p[0] = AST.FuncDefinition(type, id, argumentsList, compoundInstruction)
        else:
            p[0] = None
